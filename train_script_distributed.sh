...
python -u train.py -n "vgg16" -d "hpa" -p "True" --train-images-path="/hpakf-image-data/data/train_images" --nEpochs=1 --batchSz=64 --use-cuda=yes --crit="crl" --distributed "True"
