...
GOOGLE_APPLICATION_CREDENTIALS=/workspace/gcs_credentials.json python -u train.py -n "vgg16" -d "hpa" -p "True" --train-images-path="/hpakf-image-data/data/train_images" --nEpochs=0 --nSubsample=5000 --batchSz=32 --use-cuda=yes --crit="crl"
